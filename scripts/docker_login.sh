...
#
# Usage:
#   bash .agents/skills/agentbase/scripts/docker_login.sh --credentials-file ./docker-creds.json
#   bash .agents/skills/agentbase/scripts/docker_login.sh --registry REGISTRY --username USER --password-stdin
#   bash .agents/skills/agentbase/scripts/docker_login.sh --registry REGISTRY --username USER --password-file /tmp/pass.txt
#
