...
#   bash .agents/skills/agentbase/scripts/check_credentials.sh registry <path-to-credentials-file>
#   bash .agents/skills/agentbase/scripts/check_credentials.sh registry --credentials-file <path>
#   bash .agents/skills/agentbase/scripts/check_credentials.sh llm
#   bash .agents/skills/agentbase/scripts/check_credentials.sh aip  # alias for llm
#
